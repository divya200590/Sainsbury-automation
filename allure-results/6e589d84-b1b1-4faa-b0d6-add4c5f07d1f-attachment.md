...
Call log:
  - waiting for getByTestId('data-testid =Header/NavChild Header/NavChild[0]')

    at /Users/divyanshu/Learning/Gitrepo/Playwright-automation/tests/Sainsburytu.spec.js:9:75
```
...
>  9 | await page.getByTestId('data-testid =Header/NavChild Header/NavChild[0]').click();
     |                                                                           ^ Error: locator.click: Test timeout of 30000ms exceeded.
  10 |
  11 |
  12 |
